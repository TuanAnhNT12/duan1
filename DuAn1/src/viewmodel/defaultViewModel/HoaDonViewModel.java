...
public class HoaDonViewModel {
    ...
    public HoaDonViewModel(int maHoaDon, int maNhanVien, Timestamp thoiGian, int trangThaiThanhToan, int trangThaiOrder, int maVoucher, String ghiChu) {
    ...
    public HoaDonViewModel(int maHoaDon, int maNhanVien, Timestamp thoiGian, int trangThaiThanhToan, int trangThaiOrder, int maVoucher, BigDecimal dichVuPhatSinh, String ghiChu) {
        this.maHoaDon = maHoaDon;
        this.maNhanVien = maNhanVien;
        this.thoiGian = thoiGian;
        this.trangThaiThanhToan = trangThaiThanhToan;
